...
class MainTest {
    ...
    void checkJsonMessage() throws JSONException {
        ...
        option480.put("description",
                "Up to 480 minutes talk time per year including 240 SMS (5p per minute and 4p per SMS thereafter)");
        ...
        option40.put("description",
                "Up to 40 minutes talk time per month including 20 SMS (5p per minute and 4p per SMS thereafter)");
        ...
        option2000.put("description",
                "Up to 2000 minutes talk time per year including 420 SMS (5p per minute and 4p per SMS thereafter)");
        ...
        option160.put("description",
                "Up to 160 minutes talk time per month including 35 SMS (5p per minute and 4p per SMS thereafter)");
        ...
        option3600.put("description",
                "Up to 3600 minutes talk time per year including 480 SMS (5p per minute and 4p per SMS thereafter)");
        ...
        option300.put("description",
                "300 minutes talk time per month including 40 SMS (5p per minute and 4p per SMS thereafter)");
        ...
        assertEquals("Incorrect JSON returned",
